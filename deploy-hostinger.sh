...
#############################################
# US Bakers CRM - Automated Hostinger VPS Deployment
...
#############################################
print_info "Step 5/13: Installing MongoDB..."
...
su - $APP_USER -c "cd $APP_DIR/backend && source venv/bin/activate && python utils/seed_fresh_data.py"
